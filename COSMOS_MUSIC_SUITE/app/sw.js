const CACHE='cosmos-music-v2';
const ASSETS=['./','./index.html','./manifest.webmanifest','./src/app.js','./src/audio.js','./src/sensors.js','./src/state.js','./icons/icon-192.png','./icons/icon-512.png'];
