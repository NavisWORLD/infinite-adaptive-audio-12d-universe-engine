const CACHE='cosmos-music-v1';
const ASSETS=['./','./index.html','./COSMOS_PLAY_ALONG.html','./COSMOS_MUSIC_CONDUCTOR.html','./COSMOS_QUANTUM_BIO_INSTRUMENT.html','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
